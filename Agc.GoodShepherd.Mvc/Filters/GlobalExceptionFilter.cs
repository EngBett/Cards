...
using Agc.GoodShepherd.Domain.Exceptions;
...
namespace Agc.GoodShepherd.Mvc.Filters
{
    public class GlobalExceptionFilter : IExceptionFilter
    {
        ...
        public void OnException(ExceptionContext context)
        {
            ...
            else if (context.Exception.GetType() == typeof(DbUpdateException))
            {
                ...
                if (dbUpdateEx?.InnerException is SqlException sqlEx && (sqlEx.Number == 2627 || sqlEx.Number == 2601))
                {
        ...
        private void HandleInvalidModelStateException(ExceptionContext context, ApiResponse<string> apiResponse)
        {
            ...
            response.Code = ResponseCodes.ValidationError;
